namespace ShoppingCart
{
    internal class Program
    {
        ...
        private static void ShowCart(Product product, int[] productPrices, List<string> myShoppingCartProducts, List<int> myShoppingCartCounts)
        {
            ...
            for (int i = 0; i < myShoppingCartCounts.Count; i++)
            {
                ...
                var price = PriceFromProductName(product.Name, productPrices, productName);
